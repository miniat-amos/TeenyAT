...
/*
 * code_16_line ::= code_16_inst LBRACKET REGISTER RBRACKET COMMA immediate
 */
bool p_code_16_line() {
    bool result = false;
    shared_ptr <token> dreg, oper;
    shared_ptr <tny_word> immed;
    if((oper = p_code_16_inst()) && term(T_LBRACKET) && (dreg = term(T_REGISTER)) &&
...
/*
 * code_17_line ::= code_17_inst LBRACKET REGISTER RBRACKET COMMA register_and_immediate.
 */
bool p_code_17_line() {
    bool result = false;
    shared_ptr <token> dreg, oper;
    shared_ptr <reg_and_immed>reg_immed;
    if((oper = p_code_17_inst()) && term(T_LBRACKET) && (dreg = term(T_REGISTER)) &&
