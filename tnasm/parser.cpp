...
bool p_code_9_line()
{
    ...
    shared_ptr<tny_word> immed;
    if ((oper = p_code_9_inst()) && (sreg = term(T_REGISTER)) && (sign = p_plus_or_minus()) && (immed = p_immediate()) && term(T_EOL))
    {
...
tny_uword token_to_opcode(int id)
{
    ...
    {
    case T_SET:
        result = TNY_OPCODE_SET;
        break;
    case T_LOD:
        result = TNY_OPCODE_LOD;
        break;
    case T_STR:
        result = TNY_OPCODE_STR;
        break;
    case T_PSH:
        result = TNY_OPCODE_PSH;
        break;
    case T_POP:
        result = TNY_OPCODE_POP;
        break;
    case T_BTS:
        result = TNY_OPCODE_BTS;
        break;
    case T_BTC:
        result = TNY_OPCODE_BTC;
        break;
    case T_BTF:
        result = TNY_OPCODE_BTF;
        break;
    case T_CAL:
        result = TNY_OPCODE_CAL;
        break;
    case T_ADD:
        result = TNY_OPCODE_ADD;
        break;
    case T_SUB:
        result = TNY_OPCODE_SUB;
        break;
    case T_MPY:
        result = TNY_OPCODE_MPY;
        break;
    case T_DIV:
        result = TNY_OPCODE_DIV;
        break;
    case T_MOD:
        result = TNY_OPCODE_MOD;
        break;
    case T_AND:
        result = TNY_OPCODE_AND;
        break;
    case T_OR:
        result = TNY_OPCODE_OR;
        break;
    case T_XOR:
        result = TNY_OPCODE_XOR;
        break;
    case T_SHF:
        result = TNY_OPCODE_SHF;
        break;
    case T_ROT:
        result = TNY_OPCODE_ROT;
        break;
    case T_NEG:
        result = TNY_OPCODE_NEG;
        break;
    case T_CMP:
        result = TNY_OPCODE_CMP;
        break;
    case T_DLY:
        result = TNY_OPCODE_DLY;
        break;
    case T_JMP:
        result = TNY_OPCODE_JMP;
        break;
    case T_JE:
        result = TNY_OPCODE_JMP;
        break;
